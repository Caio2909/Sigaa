...
/**
 * Servlet implementation class listarResultadosAlunos
 */
@WebServlet("/listarResultadosAlunos")
public class listarResultadosAlunos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public listarResultadosAlunos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        try {
	            ...
	            request.getRequestDispatcher("resultadosTurma.jsp").forward(request, response);
